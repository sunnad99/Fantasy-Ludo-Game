...
class Dice:
    ...
    def show_dice(self):
        ...
        if self.dice_val_holder.count(6) == 3:
            self.game.menu.skipped_turn_text = "Obtained six III times, turn skipped..."
        ...
        for self.dice_val in self.dice_val_holder:
            ...
            self.current_text_color = self.settings.token_color_dictionary[self.game.player.current_player_color] # Choosing the color for the text to be displayed on screen based on the current player
            ...
            while self.current_turn:
                ...
                dice_shower_rect = self.settings.translucent_background_setter(25, dice_shower_text, dice_shower_coordinates, "n")
                ...
                self.settings.draw_text(dice_shower_text,self.settings.MAIN_MENU_FONT_PATH, 25, self.current_text_color, dice_shower_coordinates[0], dice_shower_coordinates[1], "n", True)
                ...
                token_chooser_rect = self.settings.translucent_background_setter(20, token_chooser_text, token_chooser_coordinates, "n")
                ...
                self.settings.draw_text(token_chooser_text,self.settings.MAIN_MENU_FONT_PATH, 20, self.current_text_color, token_chooser_coordinates[0], token_chooser_coordinates[1], "n", True)
