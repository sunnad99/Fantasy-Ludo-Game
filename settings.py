...
class Settings:
    ...
    def __init__(self, game):
        ...
        self.token_color_dictionary = {"red":self.LIGHT_RED, "green": self.LIGHT_GREEN, "blue":self.LIGHT_BLUE, "yellow": self.LIGHT_YELLOW}
        ...
        self.DWARF_CHOOSE_MENU_PATH = "images/menu images/third menu/dwarf1.png"
        self.ORC_CHOOSE_MENU_PATH = "images/menu images/third menu/orc1.png"
        self.LYCAN_CHOOSE_MENU_PATH = "images/menu images/third menu/lycan1.png"
        self.ELF_CHOOSE_MENU_PATH = "images/menu images/third menu/elf1.png"
        

        self.complete_black = 255

        # Defining the properties for the final menu"
        self.DWARF_WIN_SCREEN_PATH = "images/menu images/final menu/dwarf_ending.png"
        self.ORC_WIN_SCREEN_PATH = "images/menu images/final menu/orc_ending.png"
        self.LYCAN_WIN_SCREEN_PATH = "images/menu images/final menu/lycan_ending.png"
        self.ELF_WIN_SCREEN_PATH = "images/menu images/final menu/elf_ending.png"
